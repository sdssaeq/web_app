...
import {notify_success,notify_failed,ToastContainer} from "../components/toast-notify"
...
function LoginPage() {
  ...
  return (
      ...
      <img src={key} width={"30px"} height={"30px"}/>
        <input className="input-box" name="password" type={showPassword ? 'text' : 'password'} placeholder="Password"/>
        <button
      type="button"
